...
//mint token
func (s *Token) Mint(ctx contractapi.TransactionContextInterface, amount int) error {
...
// This function triggers a Transfer event
func (s *Token) Burn(ctx contractapi.TransactionContextInterface, amount int) error {
...
func (s *Token) BalanceOf(ctx contractapi.TransactionContextInterface, account string) (int, error) {
...
func (s *Token) ClientAccountBalance(ctx contractapi.TransactionContextInterface) (int, error) {
...
func (s *Token) ClientAccountID(ctx contractapi.TransactionContextInterface) (string, error) {
...
func (s *Token) TotalSupply(ctx contractapi.TransactionContextInterface) (int, error) {
